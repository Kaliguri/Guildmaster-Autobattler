...
- `references/music-tooling.md` — **чем генерировать музыку**: раскладка ролей трёх инструментов
  (Suno — вокал вручную, ElevenLabs Music API — структура через `composition_plan`, Stable Audio 3.0
  локально — массовый перебор), права каждого, почему Suno-API не существует, порядок внедрения.
