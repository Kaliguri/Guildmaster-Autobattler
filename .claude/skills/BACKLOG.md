...
| **pixel-art-pipeline** [отменено 2026-08-06] | PixelLab (топ-даун east), ТЗ, техника пайплайна (я звоню API, Макс QA). | Пиксель-арт снят со всех слоёв (`2026-08-01/14`, `2026-08-02/44`). Персонажей рисует Макс в плоском сторибуке; PixelLab остаётся инструментом для вендорных пиксельных паков, не для нашего арта. |
