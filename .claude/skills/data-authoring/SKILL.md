...
плумбинг сейв/загрузки (Easy Save 3) — будущий `save-system`. Здесь — форма и id-дисциплина.
...
- **save-system (будущий скилл).** data-authoring держит форму DTO (id-ссылки, `schemaVersion`,
  `[MovedFrom]`-дисциплина). Плумбинг сейв/загрузки (Easy Save 3, Steam Cloud, миграции сейвов) —
  контур save-system.
...
- **uitk / gamefeel-vfx.** Визуальные ссылки (иконки, `viewPrefab`, `UnitVisual`) авторятся здесь
  как поля SO, но их отрисовку/полиш держат UI/визуальные скиллы.
