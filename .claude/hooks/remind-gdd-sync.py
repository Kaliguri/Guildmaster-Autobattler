...
REMINDER = (
    ...
    "Провенанс и «почему» — journal-adr.md; неутверждённые числа — 00-meta/open.md; что замерить — "
    "docs/balance-issues.md. Маршрутизатор целиком: CLAUDE.md, раздел «ГДД — своё правило»."
)
