...
**Статус:** needs_review — тик-ордер, двухфазность систем, порядок сложения в сепарации и закон видимости эффектов сверены с кодом 2026-07-28; прочее отражает код на 2026-06-19
