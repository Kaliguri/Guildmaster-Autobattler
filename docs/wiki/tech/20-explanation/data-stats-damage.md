...
>
> Связано с [[tech/20-explanation/index|Explanation - Code Map]], [[tech/20-explanation/effects-abilities|Explanation - Effects & Abilities]], [[tech/40-planning/stat-system|Planning - Stat System]], [[tech/10-reference/combat-model|Reference - Combat Model]].
...
> **Композиция «Сосуд + Реликвия».** Юнит — это не один монолитный класс, а композиция: `VesselData` (кто) + `RelicData` (чем сражается). Это даёт комбинаторику контента без наследования. Подробнее — [[tech/10-reference/combat-model|Reference - Combat Model]].
