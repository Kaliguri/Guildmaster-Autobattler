...
> Исполняемое техзадание Фазы 4 «Контент-каркас». **Дизайн-источник — [[13. Дата-слой и контент-каркас (SO и конфиги)]] (ред. 3)** — при любой неоднозначности этого ТЗ решает файл 13; при конфликте файла 13 с реальным кодом — спросить Макса, не угадывать.
