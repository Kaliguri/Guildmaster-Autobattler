...
> Наполняет швы, заложенные пустыми в Фазе 1 ([10. Архитектура реализации — Фаза 1](02.%20Архитектура%20реализации%20—%20Фаза%201%20(Боевое%20ядро).md)).
> Дизайн-источник: [6. Боевая модель §5](../6.%20Боевая%20модель%20(юниты,%20статы,%20эффекты).md) (единая модель эффектов), [11. Стат-система §5](03.%20Стат-система%20(полный%20список%20статов).md) (потенция vs длительность).
