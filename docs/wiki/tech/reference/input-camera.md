...
>
> Связано: [[tech/reference/arena|Reference - Arena & Deployment]], [[tech/planning/phase-1-combat-core|Planning - Phase 1: Combat Core]], [[tech/explanation/presentation|Explanation - Presentation]], [[tech/explanation/di-events|Explanation - DI & Events]], [[controls]].
...
- **F5/R и single-mode релоад** — `LoadScene(active.name)` перезагружает всё; в мультисценовой компоновке (CoreScene + аддитивная BattleScene) поведение F5/R пересмотреть.
