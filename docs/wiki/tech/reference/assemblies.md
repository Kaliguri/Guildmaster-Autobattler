...
> Граф пересмотрен в рамках Фазы 1 (см. [[tech/planning/phase-1-combat-core|10. Архитектура реализации — Фаза 1]] §2). Старый набор (Core/Units/Combat/Guild/UI) был временным; здесь — финальная структура «как надо».
