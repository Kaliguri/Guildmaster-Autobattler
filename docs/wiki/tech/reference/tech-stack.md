...
6. **Границы сборок.** Зависимости только вниз по графу (см. [[tech/reference/assemblies|1. Сборки (Assembly Definitions)]]).
...
- **Host migration — прагматичный вариант (не бесшовный):** при выходе хоста сессия завершается, последний автосейв расшарен (Steam Cloud), другой игрок перехостит и загрузит с последней точки. Опирается на модель сейвов (см. [[tech/reference/saves|2. Сохранения]]). Бесшовная runtime-миграция — **post-release стретч**, не к фестивалю.
...
- Детали и точки автосейва — в [[tech/reference/saves|2. Сохранения]].
