...
> Связано: [[tech/how-to/project-setup|How-to - Project Setup]], [[tech/reference/tech-stack|Reference - Tech Stack]], [[tech/reference/assemblies|Reference - Assemblies]].
...
- ID контента в SO и в именах файлов держать **согласованными** — облегчит локализацию и сейвы (сейвы хранят строковые ID, см. [[tech/reference/tech-stack|Reference - Tech Stack]]).
