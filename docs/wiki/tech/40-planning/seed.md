...
Боевая симуляция при этом **детерминирована** (фиксированный тик, без Unity-физики, без `UnityEngine.Random`, детерминированный порядок итерации) — см. [[tech/10-reference/tech-stack|5. Технологический стек и архитектура]].
