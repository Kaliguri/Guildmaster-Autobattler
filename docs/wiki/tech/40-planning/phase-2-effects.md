...
> Дизайн-источник: [[tech/10-reference/combat-model|6. Боевая модель §5]] (единая модель эффектов), [[tech/40-planning/stat-system|11. Стат-система §5]] (потенция vs длительность).
