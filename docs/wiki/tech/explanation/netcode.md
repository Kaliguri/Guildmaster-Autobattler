...
>
> Связано с [[tech/explanation/simulation|Explanation - Simulation & Tick]], [[multiplayer]], [[tech/planning/phase-1-combat-core|Planning - Phase 1: Combat Core]], [[tech/00-meta/tech-changelog|Meta - Tech Changelog & Decisions]].
...
> Связь с дизайн-доком [[multiplayer]] и общим планом [[tech/explanation/run-flow|Explanation - Run Flow]] (реконнект, репликация RunState).
