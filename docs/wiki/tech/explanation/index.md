...
>
> Каждый документ раздела начинается с блока **«Простыми словами»**, потом идёт детально. Связан с [[tech/planning/phase-1-combat-core|Planning - Phase 1: Combat Core]], [[tech/planning/phase-2-effects|Planning - Phase 2: Effects & Abilities]], [[tech/reference/tech-stack|Reference - Tech Stack]].
...
| 01 | [[tech/explanation/di-events|Explanation - DI & Events]] | VContainer, скоупы, инъекция, MessagePipe vs C#-события |
| 02 | [[tech/explanation/simulation|Explanation - Simulation & Tick]] | Тик 30 Гц, аккумулятор, очередь команд, RNG, checksum, пауза |
| 03 | [[tech/explanation/data-stats-damage|Explanation - Data, Stats, Damage]] | SO-контент, `StatType`, слоистые модификаторы, пайплайн урона |
| 04 | [[tech/explanation/effects-abilities|Explanation - Effects & Abilities]] | `EffectData` + компоненты, стаки, диспел, контроль, реактивность |
| 05 | [[tech/explanation/presentation|Explanation - Presentation]] | Раздел сим/визуал, `UnitView`, сглаживание 30→60 |
| 06 | [[tech/explanation/netcode|Explanation - Netcode]] | Host-authoritative vs lockstep, что запарковано, главная таска MP |
...
| `_Parked/SimSyncProbe` | ⛔ Запаркован (lockstep-инструмент, см. [[tech/explanation/netcode|Explanation - Netcode]]) |
...
2. [[tech/explanation/di-events|Explanation - DI & Events]] — как части находят друг друга (ты просил DI отдельно).
3. [[tech/explanation/simulation|Explanation - Simulation & Tick]] — сердце, без которого остальное не имеет смысла.
4. [[tech/explanation/data-stats-damage|Explanation - Data, Stats, Damage]] → [[tech/explanation/effects-abilities|Explanation - Effects & Abilities]] — содержимое боя.
5. [[tech/explanation/presentation|Explanation - Presentation]] — как это видно.
6. [[tech/explanation/netcode|Explanation - Netcode]] — почему вся эта строгость, и куда идём по кооперативу.
