...
>
> Связано с [[tech/explanation/index|Explanation - Code Map]], [[tech/explanation/effects-abilities|Explanation - Effects & Abilities]], [[tech/planning/stat-system|Planning - Stat System]], [[tech/reference/combat-model|Reference - Combat Model]].
...
> **Композиция «Сосуд + Реликвия».** Юнит — это не один монолитный класс, а композиция: `VesselData` (кто) + `RelicData` (чем сражается). Это даёт комбинаторику контента без наследования. Подробнее — [[tech/reference/combat-model|Reference - Combat Model]].
