...
> Опирается на стат-механику из [[tech/reference/combat-model|6. Боевая модель §3]] (слоистые модификаторы, формула, `ScalableValue`).
...
Ключевое разделение, не путать (исправляет раннюю формулировку [[tech/reference/combat-model|6. Боевая модель §5.2]]).
