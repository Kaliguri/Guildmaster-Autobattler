...
> Детальная архитектура **Фазы 2** из роадмапа ([[tech/planning/roadmap|9. Roadmap реализации]]): единая модель эффектов + способности.
> Наполняет швы, заложенные пустыми в Фазе 1 ([[tech/planning/phase-1-combat-core|10. Архитектура реализации — Фаза 1]]).
> Дизайн-источник: [[tech/reference/combat-model|6. Боевая модель §5]] (единая модель эффектов), [[tech/planning/stat-system|11. Стат-система §5]] (потенция vs длительность).
