...
| **3. AI-движок (+ играбельные реликвии)** | Filter/Score/Override/Positioning/Action; 10 Гц + stagger + событийные прерывания; профиль = данные → компиляция; **2–3 пресета на архетип**; test-arena (lite). **+ Все 7 Обычных реликвий играбельны в бою:** затащены движковые расширения ([[tech/reference/combat-model|6. Боевая модель §10]]) — заряды, атака-в-движении, хил-автоатака, линия/конус, смещения — + авторинг 7 SO-ассетов + кадровый `UnitView` (sprite sheet) | Двигатель главного отличия + ранний играбельный срез реликвий. Редактор AI — post-festival | **4–5 нед** |
