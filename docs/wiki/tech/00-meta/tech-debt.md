...
**Чего в движке нет совсем:** Маскировки. Ритм (`CombatIdle`), Атака из нескольких Ударов, Блок,
рекаст и парирование — сделаны 2026-07-30/31.
...
**Порядок входа на остаток темы:** Маскировка. Она единственная трогает AI, и её удобнее делать
теперь, когда ритм устоялся.
