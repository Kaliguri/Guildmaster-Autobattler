...
- [[gdd/00-meta/qa-notes|Meta - QA Notes]] — **черновые QA-наблюдения Макса.** Файл целиком на нём: агент только читает по просьбе, ничего не пишет и не чистит — сделанное удаляет сам Макс.
