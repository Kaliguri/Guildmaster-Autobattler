...
- **Обычные** — простые противники: обычно вовсе без навыков, но **одна простая активка без выбора цели** разрешена (решено 2026-07-31). Они обучают базовым угрозам: фронт, фланг, дальний урон и плотная группа.
...
> Таблица выше перечисляет **дизайн**, а не реализацию: на 2026-07-31 в движке все пятнадцать
