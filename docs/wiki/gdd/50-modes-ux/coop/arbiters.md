...
| **Морра** | каждый тайно выбрасывает 1-5 пальцев и называет сумму всех; угадал — победил, никто не угадал — новый круг | да | да | самый «застольный» и самый живой: чем больше игроков, тем интереснее |
...
| **Чётное слово** | заявитель называет «чёт» или «нечет», затем все бросают по кости и суммируют | да | да | ставка на кости, но с решением: одна сторона выбирает половину поля |
...
**Что осталось:** сколько из шести делаем на старте (скрайб: Кости плюс Знаки, остальные по мере
скуки — реестр на то и реестр), и озвучиваются ли ритуалы барками «Сосудов» ([[presence]] §Пинги).
