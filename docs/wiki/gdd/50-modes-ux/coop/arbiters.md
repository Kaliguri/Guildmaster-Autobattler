...
### Список ритуалов (`proposed`, скрайб)

Отобраны по трём условиям: решаются за секунды, не требуют навыка (иначе арбитр начнёт зависеть от
реакции — против доктрины «скилл в подготовке»), и **масштабируются на трёх-четырёх спорщиков** или
честно помечены как парные.

| Ритуал | Как | Участников | Чем отличается на ощупь |
|---|---|---|---|
| **d6** — дефолт | все бросают, старший выигрывает; ничья — переброс участников ничьей, бесплатно | любое число | НРИ-ритуал, скины, перебросы; единственный, у которого есть коллекционный слой |
| **Камень-ножницы-бумага** | одновременный выбор из трёх | **строго двое** | единственный, где есть ощущение «переиграл», а не «повезло» |
| **Ближе к числу** | игра называет число 1-100, все пишут догадку втайне | любое число | тихий и быстрый; хорошо, когда спорят четверо сразу |
| **Пальцы на счёт три** | все выбрасывают 1-5 пальцев, считается сумма: чётная — победил заявитель | любое число | самый «застольный», играется быстрее всех |

**Правило масштаба:** парный ритуал в споре втроём просто **не предлагается** — не выбирают, а не
«играют по кругу». Турниры на выбывание за право купить сапоги нам не нужны.

**Что осталось:** нужны ли ритуалы вообще все четыре на старте (скрайб: хватит d6 и одного парного,
остальные — по мере скуки), и озвучиваются ли они барками «Сосудов» ([[presence]] §Пинги).
