...
читается мгновенно, без подсчёта на бумажке.
...
| **Ближе к числу** | игра загадала число 1-100, каждый пишет догадку втайне | да | да | тихий и мгновенный; лучший, когда спорят все четверо сразу |
| **Соломинки** | тянут жребий из общего пучка, короткая решает | да | да | ноль выбора, чистый жребий; хорош, когда спорить надоело и хочется просто решить |
...
### Заявка Макса: кликер на 5 секунд (2026-07-30, `proposed`)

«Небольшое испытание-кликер на 5 сек, кто больше — тот и молодец».

**Возражение скрайба, и оно серьёзнее, чем правило про реакцию.** Случайность в арбитре допустима
именно потому, что она **равномерна**: сегодня повезло тебе, завтра мне, и обиды не накапливаются.
Скорость клика не равномерна — она свойство человека и его мыши. Практические следствия:

1. **Один и тот же игрок будет забирать все споры.** Не «повезло», а «он всегда быстрее» — то есть
   арбитр перестаёт быть арбитром и становится правом сильного. Это хуже кубика, а не веселее.
2. **Спор превращается в проверку периферии.** Тачпад против мыши — уже решённый спор, до броска.
3. **Доступность.** Игрок с усталыми руками или моторными сложностями просто выключается из слоя,
   который мы задумали как дружеский.
4. Плюс формальное: это скилл-проверка в игре, чья доктрина — «скилл в подготовке, а не в реакции»
   ([[difficulty-skill]]). Тот же аргумент Макс сам применил к кооп-QTE воскрешения, оговорив
   «церемония, не гейт исхода».

**Три способа взять кликер, не сломав арбитра** (скрайб рекомендует Б плюс В):

| Вариант | Как | Что сохраняется |
|---|---|---|
| **А. Кликер как есть** | быстрее всех — победил | вкус «испытания», но ломается честность (см. выше) |
| **Б. «Кликер наугад»** | кликаешь 5 секунд, но побеждает тот, кто **ближе к загаданному числу** кликов | вся тактильность и азарт кликера, а решает лотерея: быстрые руки не помогают, потому что цель неизвестна |
| **В. Кликер вне споров — в церемониях** | ритуал воскрешения, синхронное кручение, «поднять павших» всей командой | кликер там, где **никто не проигрывает** — его законное место ([[interactions]] §Кооп-мини-игры) |

**Ещё кандидаты вместо Морры и Чётного слова** (`proposed`):

| Кандидат | Как | Почему стоит рассмотреть |
|---|---|---|
| **Колесо** | все вместе раскручивают колесо с именами, стрелка указывает | самое зрелищное из жребиев и единственное **общее физическое действие**; сцепляется с уже заявленным «синхронным кручением» ([[gdd/10-vision/backlog-atmosphere-light-post\|Свет, пост, атмосфера]] §6) |
| **Тяга карты** | каждый тянет карту, старшая берёт | мгновенно и без правил; реф *Across the Obelisk* |
| **Три сундучка** | у каждого свой сундук, в одном награда | наглядно и тактильно, ноль объяснений |

> **Осторожно с числом жребиев.** Соломинки, Колесо, Тяга карты и Сундучки — это **одна механика**
> в четырёх костюмах: чистая случайность, ноль решения. Реестру нужен **один** такой ритуал, но с
> самой сильной подачей; остальные будут ощущаться повтором. Скрайб предлагает оставить **Колесо**
> и снять Соломинки — крутить вместе интереснее, чем тянуть по одному.
