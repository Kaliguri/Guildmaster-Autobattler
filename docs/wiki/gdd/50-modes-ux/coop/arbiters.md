...
### Пул арбитров: кубик и другие быстрые ритуалы (2026-07-30, направление)

Заметка Макса: кроме d6 может выпадать **другая быстрая мини-игра** — «камень-ножницы-бумага» и
родня; **надо обдумать**. То есть арбитр — не один предмет, а небольшой **пул ритуалов**, из которого
спор берёт случайный.

Что это даёт: спор перестаёт быть одинаковым каждый раз, а «во что мы сейчас будем решать» само
становится частью байки. Что нужно решить: список ритуалов, кто из них требует **обоих** участников
(камень-ножницы — да, кубик — нет), и не превращается ли выбор ритуала в ещё один предмет спора.
