...
> [!info] Как работает
> Эта страница считает только персонажей с `kind: character` в [`../relics`](../relics/). Для интерактивной таблицы откройте [Реестр персонажей.base](Реестр%20персонажей.base).
