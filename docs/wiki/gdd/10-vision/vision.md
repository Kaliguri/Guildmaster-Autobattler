...
людей без своих статов), даёте им **Мементо** павших героев и ведёте гильдию через кампании.
...
5. **Ощущение важнее верности формату** — джус (SFX/VFX/gamefeel/свет) как приоритет.
...
```mermaid
flowchart LR
  Prep["Подготовка<br/>Капитан · Сосуды · Мементо · расстановка"] --> Battle["Автобой<br/>(читаемый, без микро)"]
...
- Плоский **«сторибук»**, топ-даун бой; сильный акцент на **подачу** (джус, свет).
  Пиксель-арт отменён — язык каждого слоя см. [[visual-direction|Visual Direction]].
