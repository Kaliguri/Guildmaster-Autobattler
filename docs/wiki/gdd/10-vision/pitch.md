...
> (игроки = главы гильдии; боевой «Гильдмастер» → **Капитан**), появления слоя **развития
> гильдии** и **разворота тона** (светлое → мрачное, обман ожиданий). Пока это `draft` на
...
> «Guildmaster» — **рабочее имя проекта**, не финальное название и уже не игровой термин.
> Поиск официального имени — отдельная задача.
...
**совместные главы одной гильдии**, которые ведут её — растущую **в поисках славы** — через
разные **кампании** (турнир, война, покорение вершины — цель варьируется). Сами в бой вы не вмешиваетесь — вы его **готовите**:
берёте в забег **Капитана**, набираете **«Сосудов»** (обычных людей без своих статов),
раздаёте им **Реликвии павших героев** (вся сила бойца — из Реликвии: «пилот + чемпион»),
...
- Визуал: **стилизованный пиксель-арт, топ-даун** — с сильным акцентом на **подачу и
...
|---|---|---|
| **Главы гильдии** (игроки) | Guild Leadership | 1–4 игрока — **совместное руководство одной гильдии**. Выбор Капитана, набор Сосудов, драфт Реликвий, расстановка, AI-профили, экономика, маршрут. В бою лично не участвуют |
| **Капитан** | Captain | Тот, кого гильдия **берёт в забег** (бывший боевой «Гильдмастер»). Задаёт стартовый набор Реликвий, гильдие-широкие бонусы и стиль. **Влияет на бой пассивно — через подготовку, не на поле и без ввода в бою** |
| **«Сосуд»** | Vessel | Обычный человек **без своих статов**. Носитель Реликвии — и **линза нарратива** (§9): его досье, реплики и летопись рассказывают историю забега |
| **Реликвия героя** | Hero Relic | Памятная вещь павшего героя с его силой. Несёт **весь боевой кит**. 1 на 1 Сосуда, переназначается перед боем |

> Термины **«Капитан / Captain»**, **«Главы гильдии / Guild Leadership»** при утверждении —
> в [[glossary]]; «Гильдмастер» как игровой термин вывести (остаётся рабочим именем проекта).
...
5. **Ощущение важнее верности пикселю** — **джус как приоритет дизайна**: SFX,
   VFX, gamefeel, свет. Даже пиксельная графика должна ощущаться технически богатой, сочной и
...
flowchart TB
  ...
  subgraph Run["СЛОЙ 2 · Забег (ядро-приключение + машина историй)"]
    direction LR
    Prep["Подготовка<br/>Капитан · Сосуды · Реликвии · расстановка · AI"] --> Map["Карта-развилка<br/>узлы · испытания · экономика"]
  end
...
- **Полностью автономный.** Все решения — в подготовке (Реликвии, позиции, приоритеты целей,
...
- **Модель урона** ([[stats]], [[effects]]): **школы** (Физ + Стихия, гасятся бронёй) +
  **Чистый (True)** мимо брони; поверх — **сродства** (яд/свет/тьма) как «вкус».
...
## 7. Контент боя: Реликвии · Сосуды · Капитан · Предметы

- **Реликвии** ([[relics-overview]]) — «Арканы», нейминг `The [X] (Класс)`, несут весь кит.
...
- **«Сосуды»:** **Судьба** (1 из открытых) + перк «+»/«−» (1 из 3). Прегены vs игрок-созданные.
...
- **Что НЕ переносится (принцип, решения [[journal-adr]] 25/31):** голая **мощь**, уровни,
  реликвии, Последствия. Открытия **расширяют пул вширь**, не поднимают потолок мощи.
- **Прегены** открываются метой; играя ими — открываешь **Судьбу и новые перки** (новые
  **опции**, не бафф к базе).
...
> [!question] Открыто: что именно «развивается» и как копятся истории
> Согласовать глубину со **столпом 4** и решениями 25/31: развитие = **опции + нарратив/
> летопись** без силовой инфляции? Форма «историй о забегах» (хроника? галерея байек?
> мемориал павших?) — отдельная сессия.
...
- Технически **host-authoritative** (1–4 игрока, всегда 4 «Сосуда»); хост **может** распределить
  Сосудов — но это опция, а не рельсы.
- Поверх — **свобода лезть в общее**: брать чужие Реликвии, вмешиваться, прикалывать друг друга.
...
- Связь: идея «мир, который знает, что он игра» (slow-burn раскрытие конструкта) и «шёпот
  толпы» из [[open]] — теперь **кандидаты в носители** этого разворота, а не сторонняя приправа.
...
- [[guildmaster]] — сущность → **Капитан**; роль игрока → главы гильдии.
...
- [[pillars]] — обновить столп 3 (нарратив) и добавить столп 5 (ощущение/джус) — **приняты
  2026-07-19**.
- [[glossary]] — **Капитан**, **Главы гильдии**; «Гильдмастер» — выведен.
- [[meta-progression]] — усилить как Слой 3; согласовать глубину (§9).
- [[open]] — «мир-как-конструкт» и «шёпот толпы» повысить в статусе, если тон-разворот принят.
...
- **Глубина мрака / мета:** насколько темно уходит и поднимаем ли «мир-как-конструкт» в ядро —
  вектор зафиксирован, глубину решаем отдельной сессией (§11).
- **Развитие гильдии:** что растёт и форма «историй о забегах» (§9).
- **Официальное имя игры** — отдельная задача (вектор Макса: имя-намёк в духе
  «Few Seconds — Many Deaths!», не тонущее рядом с популярными).
