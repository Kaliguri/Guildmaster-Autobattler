...
- Технически **host-authoritative** (1–4 игрока, всегда 4 «Сосуда»). Гильдия **единая**: «Сосуды»
  между игроками не распределяются, любой Гильдмастер распоряжается любым.
- Поверх — **свобода лезть в общее**: брать Реликвии из рук, вмешиваться, прикалывать друг друга.
