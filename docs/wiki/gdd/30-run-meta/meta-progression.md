...
- **Копии — общий ресурс на команду.** Всего в гильдии **4 «Сосуда»**, и это число от количества игроков не зависит: гильдия единая, «Сосуды» между игроками не распределяются ([[gdd/50-modes-ux/coop/index|Coop - Overview]] §Модель сессии). Менеджмент общего пула копий — часть кооп-решений.
