...
> [!note] Два уровня меты (2026-07-19)
...
> Отдельного канон-файла Слоя 3 пока нет — TBD.
> **Никси предлагает (`proposed`, решение за Максом):** завести `30-run-meta/guild-development.md`
> даже полупустым — у слоя игры должен быть адрес, иначе решения о нём продолжат оседать в питче.
...
- Улучшения привязаны к **реликвии**. У «Сосуда» — отдельный слой (Судьба + перки, см. [5. Реликвии](../40-content/relics-overview.md)). Два слоя не смешиваются.
