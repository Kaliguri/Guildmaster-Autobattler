...
- Это **макро-флоу**, не тик-симуляция → детерминизм боя не затрагивается. Роллы исходов (какая именно травма/Закалка) идут через `IRngService` (см. [[tech/planning/seed|Тех: 3. Рандомизация]]) — воспроизводимо по сиду.
