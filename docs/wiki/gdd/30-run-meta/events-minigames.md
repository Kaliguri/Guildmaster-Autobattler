...
> [!warning] Расхождение с `ActConfig` (флаг, сверено 2026-07-26)
> Совпадает: 15 колонок, сундук-якорь на этаже 7, три привала на этаже 8.
> **Не совпадает:** якоря **магазина на этаже 12 в конфиге нет вообще** (Shop может выпасть только
> случайно по весам зоны), а на этаже 13 стоит **три** привала (`Width: 3`), а не один.
> ГДД главнее — правится конфиг, но нужен твой вердикт: возвращать ли магазин-якорь перед боссом
> и оставлять ли предбоссовый привал одиночным. Реестр — `docs/gdd-audit-progress.md` §Дрейф.
