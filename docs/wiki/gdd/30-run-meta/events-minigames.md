...
**Открытый вопрос:** видно ли **испытание боя** заранее (при наведении на узел) или оно выдаётся на входе в бой — см. [[gdd/00-meta/open-forks|Meta - Open Forks]]. От этого зависит, где роллится испытание и насколько выбор пути по карте является настоящим решением.
...
| **Магазин** | Покупка Мементо и предметов |
...
[[minigames|Coop - Minigames & Roles]]. Здесь — мини-игры **как контент забега**: где они
