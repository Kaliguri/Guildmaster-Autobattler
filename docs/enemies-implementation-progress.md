...
- [ ] **Синий проказник — следующий и последний по ростеру.** ← ТОЧКА ВХОДА
- [ ] Тест на швырок: механика проверена трассой, своим тестом не закрыта (сферы и цикл — закрыты).

### С чего начинать по синему проказнику

Заявка Макса (2026-07-30, `open-forks` §1 «Новый контент, ждущий карточек»): «поддержка-дебаффер,
**каналом** снижает скорость восстановления маны цели на 4 ед.» Больше о нём нет ничего — ни титула, ни
статов, ни карточки.

**Почему он не сделан вместе с белым:** мана-дрейн упирается в открытый вопрос Арканы — часть китов
**безресурсна by design**, и дебафф, который для одних болезнен, а для других пустой звук, сначала нужно
решить как дизайн. Это первое, что надо вынести Максу, а не кодить.

Что уже есть в движке и пригодится: канал у способностей (`_channelSeconds`, `_channelTickSeconds`),
`StatModifierComponent` по любому стату, шкала антихила как образец «ступеней силы дебаффа». Чего нет:
стата «скорость восстановления ресурса» в списке, который дебафф мог бы крутить, — проверить `StatType`
перед разговором.

Порядок такой же, как у белого: вопросы Максу → карточка → ассеты → замер → журнал ГД.
