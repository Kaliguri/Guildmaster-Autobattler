...
- [x] **Фаза 2B: активки данными** (`68d7a8045`). Клич командира + парирование (свой ассет, кд 5),
      ...
      ниже.
- [ ] Фаза 2C: код — разгон наездника, сферы шамана, цикл голема, швырок союзника (командир +
      наездник), слепота (проказники после дизайна). ← ТЕКУЩЕЕ, но верификация заблокирована
