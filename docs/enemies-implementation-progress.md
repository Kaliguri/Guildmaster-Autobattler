...
- [ ] Фаза 2C-3: процентное пробитие брони (вердикт Макса — заводить) + разгон наездника на нём.
      ← ТЕКУЩЕЕ
- [ ] Фаза 2C-4: сферы шамана (запас 3, свой счётчик), цикл голема (фазовый компонент).
- [ ] Фаза 2C-5: швырок союзника — урон поровну обоим, стан 1 сек (вердикт Макса).
- [ ] Фаза 2D: проказники — дизайн-проход, карточки, титулы, стат-блоки; белый на готовой слепоте
      (2 стака), синий ждёт вопроса Арканы (мана-дрейн отложен).
