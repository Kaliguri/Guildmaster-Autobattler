...
- [ ] Синий проказник — ждёт вопроса Арканы (мана-дрейн отложен), карточки нет намеренно.
- [ ] Тесты на сферы и швырок: механики проверены трассой, но своими тестами не закрыты.
