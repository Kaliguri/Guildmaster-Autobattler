...
- [ ] Фаза 2B: способности — командир (клич, парирование), маг (снаряд, барьер союзнику, сферы),
      наездник (таран), брузер (стан каждой 2-й), варлок (метка, хил-отступление), голем (цикл 3, щит).
      ← ТЕКУЩЕЕ
- [ ] Фаза 2C: новый код — швырок союзника (командир, наездник), слепота (проказники после дизайна).
- [ ] Верификация в бою.
