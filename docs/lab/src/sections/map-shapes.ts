...
const section: SectionDef = {
  ...
  blocks: [
    ...
    { kind: "stands", items: FORMS },
    {
      kind: "head",
      id: "rarity",
      title: "Редкость: обычные места и чудеса света",
      lede: "Заказ Макса: частые формы держат карту, редкие делают её событием."
    },
    {
      kind: "table",
      head: ["Частота", "Что", "Сколько на акт"],
      rows: [
    ...
    },
    {
      kind: "head",
      id: "wonders",
      title: "Чудеса света — банк идей",
      lede: "Уникальные места со своим именем, своим правилом и своей строкой лора. Вердиктов нет."
    },
    {
      kind: "table",
