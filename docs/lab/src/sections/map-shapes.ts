...
const FORMS: StandDef[] = [
  ...
  },
  {
    ...
    title: "Осыпь",
    tag: "Scree",
    note: "Каждый шаг обязан смещать вбок в одну сторону — вернуться к центру нельзя. Куда бы ты ни вошёл, тебя сносит к одному краю карты.<br>Имя закреплено как <b>Осыпь</b> (<code>Scree</code>): «монотонной лестницей» в коде уже зовётся алгоритм связывания колонок.",
  ...
  blocks: [
    ...
    },
    {
      ...
      rows: [
        ...
        ["Чудо", "осыпь, логово", "1 гарантированное + шанс на второе"],
    ...
    },
    {
      ...
      html:
        ...
        "<b>Осыпь</b> (Scree), <b>Гребень</b> (Comb), <b>Перевал</b> (Muster), " +
    ...
    },
    {
      kind: "head",
      id: "delves",
      title: "Подземелья (Dungeon) и их сценарии",
