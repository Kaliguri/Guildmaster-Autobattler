...
const TRAIL_STANDS: StandDef[] = [
  ...
  },
  {
    ...
    verdict: "ПРИНЯТО 21.08: рывок должен ощущаться магией, и восемь копий дают именно это. Цена — самая дорогая вариация по рендеру; интервал остаётся ручкой в feel-конфиге.",
    decision: "2026-08-21/6",
...
const ILLUSION_STANDS: StandDef[] = [
  ...
  },
  {
    ...
    verdict: "ПРИНЯТО 21.08: яснее всех говорит «била не по телу» и не путается с осколками смерти. В движке рябь — те же копии, растущие наружу, а не отдельный префаб колец.",
    decision: "2026-08-21/6",
  ...
  },
  {
    ...
    verdict: "Случай, а не развилка: при неподвижном теле копия стоит ровно в нём. Смотреть здесь, если иллюзия начнёт читаться как ошибка.",
    decision: "2026-08-21/6",
