...
const section: SectionDef = {
  ...
  eyebrow: "Карта акта",
  lede:
    "ОТЛОЖЕНО 2026-08-02. Прототип атласной модели: рельеф показан самой землёй, фракция — страной " +
    "на ней. Берег считается полем расстояний с доменным искажением, поверх — приёмы картографии.",
  transport: false,
  blocks: [
    {
      kind: "note",
      html:
        "<b>Отложено, требует доработки</b> (Макс, 2026-08-02): «Местность мы пока что никак НЕ " +
        "рисуем. Может это и не надо». Карта остаётся картой узлов и дорог, территориальный слой на " +
        "ней один — зона влияния, см. раздел «Зоны влияния». Сюда же отложена идея летающих островов " +
        "с подбрюшьем и водопадами: она чинит настоящую болезнь (пробел получает физический смысл), " +
        "но требует решения про сеттинг, а не про подачу. Материал не выбрасываем — он пригодится, " +
        "когда дойдём до облика второго акта."
    },
    {
      kind: "head",
      id: "why",
