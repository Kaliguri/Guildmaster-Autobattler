...
const LIVE: StandDef[] = [
  { id: "feel-sheet", status: "accepted", title: "Лист пергамента", tag: "в игре", note: "Обтягивает граф с полями; рваный край считается в шейдере по периметру с поправкой на соотношение сторон — иначе рваность вытягивается вдоль длинной стороны.", size: [320, 260], draw: drawSheet },
