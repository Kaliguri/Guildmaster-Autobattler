  ...
  blocks: [
    ...
    },
    {
      ...
      items: [
        ...
        {
          id: "swept", status: "rejected", title: "Дуга за клинком", size: WIDE,
          note: "Сектор с центром в плече, заметающий угол, пройденный за strike-фазу. Форма буквально повторяет путь оружия.",
          facts: [["владелец", "ось вращения руки"], ["живёт", "кадры 13–20"], ["радиус", "длина руки, ≈0.9 H"], ["инструмент", "Shapes Disc"]],
          verdict: "Читается как <b>траектория</b>. Физично и точно, но привязана к плечу: веер расходится от юнита, а не от места удара.",
    ...
    {
      kind: "head", id: "final", title: "Принято: мазок ведёт, дуга подкладывает",
      lede:
        "Взяты оба слоя, но не на равных. У них разные центры — мазок стоит в точке контакта, дуга " +
        "растёт из плеча, — и при равной яркости кадр читался бы как две вспышки в разных местах. " +
        "Трейл отклонён: более слабое повторение дуги."
    },
    {
      kind: "split",
      items: [
        {
          id: "layers-of-one-hit", status: "accepted", title: "Три слоя одного удара", size: WIDE,
          note: "Форма принадлежит <b>оружию</b> и рисуется всегда, когда клинок махнул. Ядро и искры принадлежат <b>попаданию</b>.",
          verdict: "Поэтому промах читается сам собой: дуга есть, искр нет — а раньше он не выглядел никак, кроме слова «evade».",
    ...
    },
    {
      ...
      items: [
        {
          id: "along", status: "waiting", title: "Вдоль формы", size: [480, 330],
        ...
        {
          id: "core", status: "waiting", title: "Ядро и кайма", size: [480, 330],
        ...
        {
          id: "across", status: "waiting", title: "Поперёк толщины", size: [480, 330],
        ...
        {
          id: "layers", status: "waiting", title: "Слоями", size: [480, 330],
    ...
    },
    {
      kind: "note",
      html:
        "Способ смешения стоит <b>закрепить за сочетанием</b> (огонь+режущий всегда смешивается " +
