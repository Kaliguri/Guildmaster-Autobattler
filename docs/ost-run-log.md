...
|---|---|---|---|---|---|---|
| ~~01-A v1 (низ, тайко)~~ | 1 | 60 | — | **нет** | — | «бой в Риме, гладиаторская» — палитра трейлера. Промпт переписан |
| 01-A v2 neo-medieval, без гитары | 1 | 60 | | | | |
| 01-A-g v2 то же с гитарой | 1 | 60 | | | | |
