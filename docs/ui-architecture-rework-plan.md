...
[4] layer-cursors       — live-курсоры партнёров (II.14): над контентом и топбаром, pickingMode Ignore
[5] layer-tooltip       — тултипы (Трек Т): над топбаром и модалками, pickingMode Ignore
[6] layer-system        — поверх всего: dev-консоль (Трек К), тосты/фид (II.13)
```
