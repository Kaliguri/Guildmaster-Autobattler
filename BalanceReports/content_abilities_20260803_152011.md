# Способности китов
_Сгенерировано 2026-08-03 15:20 — SimBench_
...
| Arcanist | arcane_volley | 0 | 15 | 0.35 | NearestEnemy | 0 | 0 | Разлад | Магическая защита цели снижена. Стаки складываются и обновляют срок. |
| Assassin | shadow_step | 0 | 75 | 0 | Self | 0 | 0 | Скрытность |  |
| Cryomancer | ice_zone | 0 | 40 | 0.15 | NearestEnemy | 3 | 0 | Изморозь | Холод копится на цели: сначала замедляет, потом приковывает к месту, а на пределе обращает в лёд. |
...
| Druid | spore_burst | 0 | 45 | 0 | AllEnemiesWithTag | 1.5 | 0 |  |  |
| Emberkeeper | fan_the_flames | 0 | 30 | 0 | LowestHpAlly | 0 | 0 | Раздуть жар · Заслон от жара · Тёплый пепел | Сильное развеивание: снимает даже то, что не берёт лекарь. | Урон огнём снижен на 25%. | Каждый стак сокращает длительность дебаффов на 10%, до половины. |
...
| WaterMonk | water_shield | 0 | 35 | 0 | LowestHpAlly | 0 | 0 | Водяной щит | Поглощает урон 5 секунд. По истечении или при уничтожении разлетается волной: толкает и замедляет врагов рядом. |
