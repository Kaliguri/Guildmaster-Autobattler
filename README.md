...
сами не умеют сражаться; сила приходит к ним из **Мементо**, которые они принимают. Перед боем вы
решаете, кто какое возьмёт, где встанет и кого будет бить, — а дальше бой идёт сам, и вы гнёте его в
...
| | |
|---|---|
| **Сосуды и Мементо** | Сосуд — человек, Мементо — боец. Принятое Мементо даёт свои статы и весь свой кит: это ближе к выбору чемпиона, чем к надеванию меча |
...
| **Рогалик-забег** | Ветвящаяся карта акта: бои, события, лавки, элитные гильдии и босс в конце. Награды — Мементо, золото и вместимость |
...
**Контент.** 108 эффектов, 27 Мементо, 20 врагов, 56 тегов, 30 AI-профилей, 8 энкаунтеров — всё
