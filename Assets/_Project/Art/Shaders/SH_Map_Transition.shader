Shader "Guildmaster/Map/Transition"
{
    ...
    Properties
    {
        ...
        _ShapeTex ("Форма смыкания (белое = закрывается последним)", 2D) = "black" {}
        _UseShape ("Брать форму из текстуры", Range(0, 1)) = 0
        _Seed ("Жребий узора (xy сдвиг, z поворот, w масштаб)", Vector) = (0, 0, 0, 1)
        _Warp ("Искажение узора вторым слоем", Range(0, 0.5)) = 0.12
    }
