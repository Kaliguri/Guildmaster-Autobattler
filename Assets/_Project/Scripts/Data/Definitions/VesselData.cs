...
{
    /// <summary>
    /// «Сосуд» — человек, носящий Реликвию. Своих боевых статов у него нет: весь кит приходит от
    /// Реликвии, а Сосуд несёт идентичность и нарратив (ГДД «Питч» §7, «Процедурный лор»).
    ...
    public sealed class VesselData : ContentDefinition
    {
        ...
        [Tooltip("Статовая нагрузка Судьбы — то, чем авторский «Сосуд» отличается от процедурного.\n\n" +
                 ...
                 "И это не способ дать «Сосуду» собственные статы в обход Реликвии — по ГДД он «обычный " +
