namespace Guildmaster.Data.Definitions
{
    ...
    public enum TargetingMode
    {
        ...
        /// <summary>
        /// Враг с наибольшей БРОНЁЙ — тому, чей удар гложет защиту (ближняя форма Десятины: шред окупается
        /// только на толстом). Считается СУММА физической и магической: «броня» в карточках — одно понятие,
        /// а режим общий для всех китов, и привязка к одной школе сделала бы его личным для одного шреда.
        /// </summary>
        HighestArmor = 9,
    }
}
