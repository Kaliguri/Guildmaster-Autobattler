namespace Guildmaster.Data.Definitions
{
    ...
    public enum UnitAnimationState
    {
        ...
        /// <summary>
        /// Боевое ожидание: стоит с оружием НАГОТОВЕ. Отличается от <see cref="Idle"/> ровно тем, чем
        /// отличается бой от привала, и признак у него такой же простой — есть цель. Нулевой кадр всех
        /// атак поставлен в эту же позу, поэтому вход в удар отсюда не роняет клинок и не поднимает его
        /// заново.
        /// </summary>
        CombatIdle = 7,
    }
