...
namespace Guildmaster.Data.Definitions
{
    ...
    /// повторяется у многих Реликвий, поэтому спрайты обязаны быть отвязаны от него. Но и отдельной
    /// сущности им не нужно: владелец у брони и у оружия один — Реликвия (у врага —
