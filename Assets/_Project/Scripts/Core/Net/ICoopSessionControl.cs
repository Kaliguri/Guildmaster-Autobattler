...
namespace Guildmaster.Core.Net
{
    ...
    public interface ICoopSessionControl
    {
        ...
        /// <summary>
        /// Нас позвали в чужую игру, пока мы играем: имя зовущего и его адрес.
        /// </summary>
        /// <remarks>
        /// <b>Это ВОПРОС, а не команда.</b> Steam присылает приглашение фоном; согласия игрока в нём
        /// нет, и подключаться самим по нему нельзя — иначе чужой клик вышвыривал бы человека из его
        /// собственного забега. Ответ приходит через <see cref="AcceptInvite"/>.
        /// <para>Приходит, только когда игра ЗАПУЩЕНА. Если она закрыта, Steam стартует её сам и
        /// приглашение превращается в <c>JoinRequested</c> — там согласие уже дано.</para>
        /// </remarks>
        event Action<string, ulong> Invited;

        /// <summary>Согласиться на приглашение: войти в игру по адресу пригласившего.</summary>
        void AcceptInvite(ulong hostSteamId);
