namespace Guildmaster.Core.Net
{
    ...
    public static class DecisionKeys
    {
        ...
        /// <summary>
        /// Согласие выйти со двора гильдии в забег.
        /// </summary>
        /// <remarks>
        /// <b>Последнее место, где роли расходились сознательно</b> (вердикт Макса 08.08.2026: «Надо
        /// вообще его сделать когда кликают оба, как с готовностью»). Кнопки «Начать забег» у гостя не
        /// было намеренно: его клик закрыл бы двор ему одному, а напарник остался бы стоять. Общее
        /// согласие снимает и причину, и исключение.
        /// </remarks>
