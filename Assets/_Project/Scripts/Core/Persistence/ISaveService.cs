...
namespace Guildmaster.Core.Persistence
{
    ...
    public interface ISaveService
    {
        ...
        /// <summary>
        /// Удалить поддерево целиком — ключ здесь означает каталог, а не файл. Нужен для удаления
        /// профиля: точечный <see cref="Delete"/> снёс бы только сам <c>profile</c>, оставив гильдии и
        /// их забеги висеть мусором, который никто больше не покажет и не подберёт.
        /// </summary>
        void DeleteTree(string prefix);
