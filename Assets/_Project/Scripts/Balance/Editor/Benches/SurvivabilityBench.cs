    ...
    public static class SurvivabilityBench
    {
        ...
        public static (string csv, string md) Run()
        {
            ...
            string notes =
                ...
                $"**Кит, собирающий живучесть с союзников** («Десятина»), в этой линзе мерится с заменой " +
        ...
        /// «Десятина» сажает носителя на 1% HP и добирает недостающее данью с команды, а в этом
        ...
        private static void CompensateSoloTithe(SimEnvironment env, RuntimeUnit victim)
        {
            ...
            for (int i = 0; i < effects.Count; i++)
            {
                ...
                {
                    if (comps[c] is not TitheComponent) continue;
                    tithe = effects[i];
                    break;
                }
                if (tithe != null) break;
