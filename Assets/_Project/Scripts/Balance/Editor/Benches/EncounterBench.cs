    ...
    public static class EncounterBench
    {
            ...
            Attempt[][] grid, bool[] playable, float overtimeStart, out string md)
        {
            ...
            string notes =
                ...
                "испытуемого. Это точка отсчёта: кит полезен, если его строка проходит больше боёв или платит " +
                "меньше, чем контроль. Кит, стоящий НИЖЕ контроля, отряд ослабляет — и это вывод, а не шум. " +
                ...
                "в таблице сложности они есть. Внимание: тренировочные наборы (`DummyPair` и родня) сейчас " +
                "числятся тиром Common, поэтому проходимость они всё-таки задирают — их стоит пометить " +
                "Special, и тогда фильтр сработает сам. " +
