...
namespace Guildmaster.Presentation.Body
{
    ...
    public interface IUnitPartLookup
    {
        ...
        /// <summary>
        /// Чем юнит исполняет приём ЭТОЙ рукой: предмет в её хвате, а если рука пуста — сама кисть (кулак).
        /// <see cref="HandSlot.None"/> — «чем угодно»: первое оружие, иначе первая кисть. Тело из одного
        /// спрайта отвечает собой целиком.
        /// </summary>
        /// <remarks>
        ...
        /// <para>
        /// А вот подставлять предмет ДРУГОЙ руки запрос по слоту не имеет права: у бойца с мечом справа и
        /// щитом слева «удар левой» — это щит-бэш, и подмена мечом соврала бы о приёме.
        /// </para>
        /// </remarks>
