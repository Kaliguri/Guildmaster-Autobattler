    ...
    public static class BoneUnitClipRecipes
    {
        ...
        public static string Attack()
        {
            using (var w = new RigWriter(Profile()))
            {
                ...
                w.At(0.250f).Bend("Torso", -4f, Near, Out).Bend("Shoulder_R", 158f, Near, Out)
                            .Bend("Shoulder_L", 27f, Near, Out).Bend("LowerLeg_R", 8f, Near, Out)
                            .Bend("Head", 17f, Near, Out).Bend("LowerArm_R", 10f, Near, Out).Bend("LowerArm_L", 13f, Near, Out)
                ...
                w.At(0.333f).Bend("Torso", -4f, Near, In).Bend("Shoulder_R", 158f, Near, In);
                ...
                w.At(0.583f).Bend("Torso", -26f, Near, Out).Bend("Shoulder_R", -36f, Cw, Out)
                            .Bend("Shoulder_L", 3f, Near, Out).Bend("LowerLeg_R", 12f, Near, Out)
                            .Bend("LowerLeg_L", 6f, Near, Out).Bend("UpperLeg_L", -4f, Near, Out)
                            .Bend("Head", -18f, Near, Out).Bend("LowerArm_R", 10f, Near, Out)
        ...
        public static string Attack2()
        {
            using (var w = new RigWriter(Profile()))
            {
                ...
                w.At(0.250f).Bend("Torso", -12f, Near, Out).Bend("LowerLeg_L", 25f, Near, Out).Bend("LowerLeg_R", 27f, Near, Out)
                            .Bend("UpperLeg_L", -5f, Near, Out).Bend("UpperLeg_R", 6f, Near, Out)
                            .Bend("Shoulder_R", -30f, Near, Out).Bend("Shoulder_L", 8f, Near, Out)
                            .Bend("Head", 6f, Near, Out).Bend("LowerArm_R", 10f, Near, Out).Bend("LowerArm_L", -5f, Near, Out)
                ...
                w.At(0.583f).Bend("Torso", 9f, Near, Out).Bend("LowerLeg_L", 4f, Near, Out).Bend("LowerLeg_R", 5f, Near, Out)
                            .Bend("UpperLeg_L", -9f, Near, Out).Bend("UpperLeg_R", 12f, Near, Out)
                            .Bend("Shoulder_R", 137f, Near, Out).Bend("Shoulder_L", -12f, Near, Out)
                            .Bend("Head", -6f, Near, Out).Bend("LowerArm_R", 0f, Near, Out).Bend("LowerArm_L", 9f, Near, Out)
        ...
        public static string Attack3()
        {
            using (var w = new RigWriter(Profile()))
            {
                ...
                w.At(0.250f).Bend("Torso", 7f, Near, Out).Bend("Shoulder_R", 172f, Near, Out)
                            .Bend("Shoulder_L", 24f, Near, Out).Bend("LowerLeg_R", 10f, Near, Out)
                            .Bend("LowerLeg_L", 6f, Near, Out).Bend("UpperLeg_R", 7f, Near, Out)
                            .Bend("Head", 14f, Near, Out).Bend("LowerArm_R", 14f, Near, Out).Bend("LowerArm_L", 12f, Near, Out)
                ...
                w.At(0.333f).Bend("Torso", 7f, Near, In).Bend("Shoulder_R", 172f, Near, In);
                // Cw for the same reason as the vertical cut: from behind the back the short way home runs
                // backwards over his own head.
                w.At(0.583f).Bend("Torso", -14f, Near, Out).Bend("Shoulder_R", -22f, Cw, Out)
                            .Bend("Shoulder_L", 5f, Near, Out).Bend("LowerLeg_R", 14f, Near, Out)
                            .Bend("LowerLeg_L", 8f, Near, Out).Bend("UpperLeg_L", -6f, Near, Out)
                            .Bend("Head", -15f, Near, Out).Bend("LowerArm_R", 6f, Near, Out).Bend("LowerArm_L", 8f, Near, Out)
        ...
        public static string AttackCharge()
        {
            using (var w = new RigWriter(Profile()))
            {
                ...
                w.At(0f).Bend("Torso", -11f, Near, Lin).Bend("UpperLeg_R", 30f, Near, Lin).Bend("UpperLeg_L", -8f, Near, Lin)
                        .Bend("LowerLeg_L", 40f, Near, Lin).Bend("LowerLeg_R", 10f, Near, Lin).Bend("Head", 5f, Near, Lin)
                        .Bend("Shoulder_R", BladeGatheredShoulder, Near, Lin).Bend("LowerArm_R", BladeGatheredElbow, Near, Lin)
                ...
                w.At(0.117f).Bend("Shoulder_R", BladeGatheredShoulder, Near, Soft).Bend("LowerArm_R", BladeGatheredElbow, Near, Soft)
                            .Bend("UpperLeg_L", 30f, Near, Soft).Bend("UpperLeg_R", -8f, Near, Soft)
                            .Bend("LowerLeg_L", 10f, Near, Soft).Bend("LowerLeg_R", 45f, Near, Soft)
                ...
                w.At(0.300f).Bend("Torso", 14f, Near, Out).Bend("Shoulder_R", 184f, Near, Out)
                            .Bend("Shoulder_L", 26f, Near, Out).Bend("UpperLeg_L", -16f, Near, Out).Bend("UpperLeg_R", 24f, Near, Out)
                            .Bend("LowerLeg_L", 32f, Near, Out).Bend("LowerLeg_R", 12f, Near, Out)
                            .Bend("Head", 18f, Near, Out).Bend("LowerArm_R", 16f, Near, Out).Bend("LowerArm_L", 12f, Near, Out)
                ...
                w.At(0.433f).Bend("Torso", 14f, Near, In).Bend("Shoulder_R", 184f, Near, In);
                w.At(0.733f).Bend("Torso", -30f, Near, Out).Bend("Shoulder_R", -34f, Cw, Out)
                            .Bend("Shoulder_L", -20f, Near, Out).Bend("UpperLeg_L", -36f, Near, Out).Bend("UpperLeg_R", 44f, Near, Out)
                            .Bend("LowerLeg_L", 44f, Near, Out).Bend("LowerLeg_R", 16f, Near, Out)
                            .Bend("Head", -18f, Near, Out).Bend("LowerArm_R", 4f, Near, Out).Bend("LowerArm_L", 15f, Near, Out)
        ...
        public static string Block()
        {
            using (var w = new RigWriter(Profile()))
            {
                ...
                w.At(0.117f).Bend("Shoulder_L", 54f, Near, Out).Bend("LowerArm_L", -15f, Near, Out)
                ...
                w.At(0.450f).Bend("Shoulder_L", 52f, Near, Soft).Bend("LowerArm_L", -13f, Near, Soft)
        ...
        public static string Idle()
        {
            using (var w = new RigWriter(Profile()))
            {
                ...
                Resting(w, 0f, Lin);
                w.At(1.100f).Bend("Torso", -1.5f, Near, Out).Bend("Shoulder_L", -13.5f, Near, Out)
                            .Bend("Shoulder_R", -19f, Near, Out).Bend("Head", 1.5f, Near, Out)
                            .Bend("LowerArm_L", -4f, Near, Out).Bend("LowerArm_R", -10f, Near, Out)
        ...
        static void Resting(RigWriter w, float time, RigWriter.Ease ease)
        {
            w.At(time).Bend("Torso", 0f, Near, ease).Bend("Head", 0f, Near, ease)
                      .Bend("Shoulder_R", -21f, Near, ease).Bend("Shoulder_L", -12f, Near, ease)
                      .Bend("LowerArm_R", -8f, Near, ease).Bend("LowerArm_L", -6f, Near, ease)
        ...
        public static string CombatIdle()
        {
            using (var w = new RigWriter(Profile()))
            {
                ...
                w.At(0.900f).Bend("Torso", -6.5f, Near, Soft).Bend("Head", 5.5f, Near, Soft)
                            .Bend("Shoulder_R", 40f, Near, Soft).Bend("Shoulder_L", 24f, Near, Soft)
                            .Bend("LowerArm_R", 18f, Near, Soft).Bend("LowerArm_L", 26f, Near, Soft)
                            .Bend("UpperLeg_L", -6f, Near, Soft).Bend("UpperLeg_R", 8f, Near, Soft)
                            .Bend("LowerLeg_L", 10f, Near, Soft).Bend("LowerLeg_R", 12f, Near, Soft)
        ...
        static void Braced(RigWriter w, float time, RigWriter.Ease ease)
        {
            w.At(time).Bend("Torso", -5f, Near, ease).Bend("Head", 4f, Near, ease)
                      .Bend("Shoulder_R", 38f, Near, ease).Bend("Shoulder_L", 22f, Near, ease)
                      .Bend("LowerArm_R", 18f, Near, ease).Bend("LowerArm_L", 26f, Near, ease)
                      .Bend("UpperLeg_L", -6f, Near, ease).Bend("UpperLeg_R", 8f, Near, ease)
                      .Bend("LowerLeg_L", 10f, Near, ease).Bend("LowerLeg_R", 12f, Near, ease)
                           ...
                           float bobLow, float bobHigh, float lean, float armSwing, bool bladeGathered = false)
        {
            ...
            for (int step = 0; step < 2; step++)
            {
                ...
                w.At(contact).Bend($"UpperLeg_{front}", hipSwing, Near, Out).Bend($"UpperLeg_{rear}", -hipSwing * RearShare, Near, Out)
                             .Bend($"LowerLeg_{front}", StraightKnee, Near, Out).Bend($"LowerLeg_{rear}", kneeLift * 0.35f, Near, Out)
                             .Bend($"Foot_{front}", ToeUp, Near, Out).Bend($"Foot_{rear}", ToeDown * 0.5f, Near, Out)
                ...
                w.At(down).Bend($"UpperLeg_{front}", hipSwing * 0.65f, Near, Soft).Bend($"UpperLeg_{rear}", -hipSwing * RearShare * 0.8f, Near, Soft)
                          .Bend($"LowerLeg_{front}", kneeLift * 0.75f, Near, Soft).Bend($"LowerLeg_{rear}", kneeLift * 0.5f, Near, Soft)
                          .Bend($"Foot_{front}", 0f, Near, Soft).Bend($"Foot_{rear}", ToeDown * 0.7f, Near, Soft)
                          .Bend("Torso", lean * 1.15f, Near, Soft)
                          .Move("Hips", new Vector2(RestHips.x, bobLow));

                w.At(passing).Bend($"UpperLeg_{front}", hipSwing * 0.1f, Near, Lin).Bend($"UpperLeg_{rear}", -hipSwing * 0.3f, Near, Lin)
                             .Bend($"LowerLeg_{front}", StraightKnee, Near, Lin).Bend($"LowerLeg_{rear}", kneeLift, Near, Lin)
                             .Bend($"Foot_{front}", ToeDown * 0.25f, Near, Lin).Bend($"Foot_{rear}", ToeUp * 0.5f, Near, Lin)
                             .Bend("Torso", lean, Near, Soft)
                             .Move("Hips", new Vector2(RestHips.x, bobMid));

                w.At(up).Bend($"UpperLeg_{front}", -hipSwing * RearShare * 0.55f, Near, Soft).Bend($"UpperLeg_{rear}", hipSwing * 0.6f, Near, Soft)
                        .Bend($"LowerLeg_{front}", StraightKnee * 1.4f, Near, Soft).Bend($"LowerLeg_{rear}", kneeLift * 0.55f, Near, Soft)
                        .Bend($"Foot_{front}", ToeDown, Near, Soft).Bend($"Foot_{rear}", ToeUp * 0.6f, Near, Soft)
                ...
                w.At(contact).Bend("Shoulder_L", -armSwing * sign, Near, Soft);
                w.At(passing).Bend("Shoulder_L", 0f, Near, Soft);
                ...
                if (bladeGathered)
                    w.At(contact).Bend("Shoulder_R", BladeGatheredShoulder - armSwing * 0.35f * sign, Near, Soft)
                                 .Bend("LowerArm_R", BladeGatheredElbow, Near, Soft)
                                 .Aim("weapon", BladeGatheredAim, Near, Soft);
                else
                    w.At(contact).Bend("Shoulder_R", armSwing * sign, Near, Soft);
            }

            // Close the loop on the first pose so the cycle does not jump.
            w.At(start + length).Bend("UpperLeg_L", hipSwing, Near, Out).Bend("UpperLeg_R", -hipSwing * RearShare, Near, Out)
                                .Bend("LowerLeg_L", StraightKnee, Near, Out).Bend("LowerLeg_R", kneeLift * 0.35f, Near, Out)
                                .Bend("Foot_L", ToeUp, Near, Out).Bend("Foot_R", ToeDown * 0.5f, Near, Out)
                                .Bend("Torso", lean, Near, Soft)
                                .Bend("Shoulder_L", -armSwing, Near, Soft)
                                .Bend("Head", -lean * 0.4f, Near, Soft)
                                .Move("Hips", new Vector2(RestHips.x, bobMid));

            if (bladeGathered)
                w.At(start + length).Bend("Shoulder_R", BladeGatheredShoulder - armSwing * 0.35f, Near, Soft)
                                    .Bend("LowerArm_R", BladeGatheredElbow, Near, Soft)
                                    .Aim("weapon", BladeGatheredAim, Near, Soft);
            else
                w.At(start + length).Bend("Shoulder_R", armSwing, Near, Soft);
        }
        ...
        public static string Stun()
        {
            using (var w = new RigWriter(Profile()))
            {
                ...
                w.At(0.2f).Bend("Torso", 12f, Near, Out).Bend("Head", 16f, Near, Out)
                          .Bend("Shoulder_R", -34f, Near, Out).Bend("LowerArm_R", 10f, Near, Out)
                          .Bend("Shoulder_L", -28f, Near, Out).Bend("LowerArm_L", 8f, Near, Out)
                          .Bend("LowerLeg_L", 14f, Near, Out).Bend("LowerLeg_R", 10f, Near, Out)
                ...
                w.At(1.2f).Bend("Torso", 12f, Near, Soft).Bend("Head", 16f, Near, Soft)
                          .Bend("Shoulder_R", -34f, Near, Soft).Bend("LowerArm_R", 10f, Near, Soft)
                          .Bend("Shoulder_L", -28f, Near, Soft).Bend("LowerArm_L", 8f, Near, Soft)
                          .Bend("LowerLeg_L", 14f, Near, Soft).Bend("LowerLeg_R", 10f, Near, Soft)
        ...
        static void Stance(RigWriter w, float time)
        {
            w.At(time).Bend("Torso", 0f).Bend("Head", 0f)
                      .Bend("Shoulder_R", 0f).Bend("LowerArm_R", 0f)
                      .Bend("Shoulder_L", 0f).Bend("LowerArm_L", 0f)
                      .Bend("UpperLeg_L", 0f).Bend("UpperLeg_R", 0f).Bend("LowerLeg_L", 0f).Bend("LowerLeg_R", 0f)
