...
namespace Guildmaster.Combat.Effects.Components
{
    ...
    /// (умер далеко — кости не донести); <c>_summonAbilityId</c> — от какой именно способности считаются
    /// призывы (пусто = любые свои). Размер щита и сила его взрыва живут в самом эффекте костей.</para>
