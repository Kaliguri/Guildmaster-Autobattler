...
namespace Guildmaster.Combat.Effects.Components
{
    ...
    /// <para><b>Числа:</b> своих нет — компонент лишь правило «метка переезжает на смерти носителя».
    /// Что метка ДАЁТ (уязвимость, приоритет цели) и сколько живёт — в самом эффекте; выбор нового
    /// носителя — ближайший живой враг источника, без настроек.</para>
    /// <para><b>Когда срабатывает:</b> на <see cref="CombatEvent.UnitDied"/> носителя метки.</para>
    /// </summary>
    [Serializable]
