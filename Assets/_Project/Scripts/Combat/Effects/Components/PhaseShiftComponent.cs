...
{
    /// <summary>
    /// «Смещение» Арканиста (карточка [[the-rift]]): pre-damage реактив с периодом. Первый удар после
    /// готовности периода ОТМЕНЯЕТСЯ целиком, носитель уходит телепортом на <see cref="_shiftDistance"/>
