...
namespace Guildmaster.Combat
{
    ...
    public interface IBattleView
    {
        ...
        /// <summary>
        /// Снимок тюнинга боя. Мозгу он нужен затем же, зачем движению и удару: правила позиционирования
        /// (предел отступления) — это настройка боя, а не константа в голове одного класса.
        /// </summary>
        Core.Simulation.SimTuning Tuning { get; }
    }
}
