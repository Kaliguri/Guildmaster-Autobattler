...
namespace Guildmaster.Game.Flow
{
    ...
    public sealed class BattleBootstrap : IStartable, IDisposable
    {
        ...
        // Запуск боя: поставить отряд и врагов, затем ОБЯЗАТЕЛЬНАЯ фаза расстановки (пауза, враги видны,
        // отряд двигается) — «Начать» из панели снимет паузу и запустит бой. Отряд материализуется здесь:
        // вне боя он стоит телами мира, а не юнитами симуляции (02.08.2026, шаг 1б). Проверка «а вдруг уже
        // стоит» осталась для ретрая и dev-запусков, где бой мог быть поставлен другой дорогой.
