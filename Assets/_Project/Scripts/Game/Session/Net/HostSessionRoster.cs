...
namespace Guildmaster.Game.Session.Net
{
    ...
    public sealed class HostSessionRoster : ISessionRoster, IStartable, ITickable, IDisposable
    {
        ...
        /// <summary>
        /// Участник ушёл. <b>Себя из состава не вычёркиваем никогда</b> — отключиться от самого себя
        /// нельзя.
        /// </summary>
        /// <remarks>
        /// Второй рубеж к поколению сессии в транспорте, и он здесь не «на всякий случай»: номер пира
        /// значит разное в разных ролях. У гостя ноль — это хозяин, у хозяина ноль — он сам. Игрок,
        /// побывавший гостем и поднявший затем свой хостинг, получал запоздалое «пир 0 отключился» от
        /// прошлого соединения — и состав вычёркивал хозяина, оставляя сеанс без него: «нас нет в
        /// составе сеанса (наш номер 0, участников 1)» (прогон вдвоём 08.08.2026). Транспорт такой хвост
        /// теперь отсекает, но условие «я не могу от себя отключиться» верно само по себе и дешевле
