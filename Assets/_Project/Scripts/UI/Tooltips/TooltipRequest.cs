namespace Guildmaster.UI.Tooltips
{
    ...
    public enum TooltipKind
    {
        ...
        /// <summary>Мементо по id: имя, кит, теги, описание.</summary>
        Relic = 2,
    ...
    /// «покажи мементо <c>relic.ember_heart</c>», а не «покажи вот эту разметку».
    /// </summary>
    /// <remarks>
    ...
    /// место рисовало бы своё, и «мементо» выглядела бы по-разному на трёх экранах.
    /// </remarks>
