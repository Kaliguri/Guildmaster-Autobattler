...
namespace Guildmaster.UI
{
    ...
    public sealed class PartyScreenPresenter
    {
        ...
        /// заведён наём, — и тогда место представляет сама Мементо: экран честно показывает то, чем
        ...
        /// Мементо — то же, что показывают награда и витрина Мементо.
        /// </summary>
        /// <remarks>
        ...
        /// <para>Базовое Мементо лица не даёт намеренно: оно означает «человек ещё ничем не занят»,
