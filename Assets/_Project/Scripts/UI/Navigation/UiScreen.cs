...
namespace Guildmaster.UI
{
    ...
    public abstract class UiScreen
    {
        ...
        /// <summary>
        /// Экран требует под собой ЗАДНИК (стол за экранами) независимо от своего <see cref="Kind"/> и от
        /// того, что происходит в мире. Нужен там, где смотреть под экран незачем: настройки заняли кадр
        /// целиком, панели у них нет, и под строками громкости мельтешит арена.
        /// <para>
        /// Свойство ЭКРАНА, а не решение вызывающего. Раньше признак жил в <see cref="Kind"/>, который
        /// назначает call-site: одни и те же настройки открывались из меню как Page (задник был) и из
        /// паузы как Modal (задника не было), а по коду экрана понять, что у него за спиной, было нельзя.
        /// Тип отвечает за поведение — глушение ввода и видимость нижних; «чем закрыт мир» — другая роль.
        /// </para>
        /// </summary>
