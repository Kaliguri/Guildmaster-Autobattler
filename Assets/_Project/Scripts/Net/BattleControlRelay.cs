...
namespace Guildmaster.Net
{
    ...
    /// <c>PauseCommand</c> с будущим <c>TargetTick</c> и рассылал её всем, чтобы «все применили на одном
    /// тике» — это lockstep-модель, которую мы отвергли 19.06.2026: клиенты свою симуляцию не тикают, и
    /// применять им нечего. Заодно он был <c>NetworkBehaviour</c>, то есть требовал NGO и сцены —
