...
namespace Guildmaster.Net.Tape
{
    ...
    /// найдёт никогда. Единственный способ адресовать её по сети — собрать словарь из всех мементо.</para>
    ...
    public sealed class TapeAbilityIndex
    {
        ...
        /// <summary>Найти способность по id. <c>false</c> = такой нет ни в одном мементо.</summary>
