...
namespace Guildmaster.Tests.EditMode.UI
{
    ...
    public sealed class UssDeadCodeTests
    {
        ...
        private static readonly string[] MarkerOnly =
        {
            ...
            // СЕМЕЙСТВО, у которого стилизованы только модификаторы: словарь подсказки красит слово
            // по категории (.gm-kw--status и далее), а сам .gm-kw ничего не задаёт и задавать не
            // должен — общего у категорий ровно ничего, кроме принадлежности к словарю.
            "gm-kw",
        };
