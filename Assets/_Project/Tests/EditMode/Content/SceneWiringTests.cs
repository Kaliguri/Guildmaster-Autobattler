...
namespace Guildmaster.Tests.EditMode.Content
{
    ...
    {
        /// <summary>
        /// Поля, пустота которых — баг разводки, а не «пусто = дефолт».
        /// <para>После разбора фолбэков (2026-07-26) сюда входит и то, что раньше считалось «осознанным
        /// фолбэком»: <c>_audioCatalog</c> и <c>_actConfig</c> по-прежнему деградируют в рантайме (тишина,
        /// карта по дефолтам кода), но деградация — не режим работы, а авария, и её место здесь.</para>
        /// </summary>
