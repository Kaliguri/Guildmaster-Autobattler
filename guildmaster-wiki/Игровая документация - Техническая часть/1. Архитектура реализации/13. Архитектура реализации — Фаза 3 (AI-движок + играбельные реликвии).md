...
| **7** | **Закрытие фазы**: все 7 срезов в харнессе, отметка в [9. Roadmap §3](9.%20Roadmap%20реализации.md), ретро + синхрон AI-словаря [0.3](0.3.%20Модель%20AI-настроек%20реликвий.md) под фактический `AIProfile` | ⏳ §11 |
...
**Дизайн (канон — [карточка «Железный копейщик»](1.%20Обычная%20Редкость%20-%20Железный%20копейщик.md)):**
...
### §10.1 — Светлый пастырь  *(хилер, дальний)* — ПЕРВЫЙ СРЕЗ ШАГА 6 (implementation-ready)

> Следующая задача реализации (в новом чате). Канон — [карточка «Светлый пастырь»](Игровая%20документация%20-%20Геймдизайн/1.%20Контент%20-%20Реликвии/1.%20Обычная%20Редкость%20-%20Светлый%20пастырь.md). Тянет расширения **§9.2** (хил-АА снарядом) и **§9.10** (глобальная одиночная активка). Решения Макса: лечение = `AutoAttackDamage × HealShieldDealtEff`; доставка АА — **снаряд-хил**.
...
- Ретро + синхрон AI-словаря [0.3](0.3.%20Модель%20AI-настроек%20реликвий.md) под фактический `AIProfile` (если ручки разошлись с реализацией).
